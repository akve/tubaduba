...
--
-- Table structure for table `wpap_bwg_option`
--

DROP TABLE IF EXISTS `wpap_bwg_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wpap_bwg_option` (
...
--
-- Dumping data for table `wpap_bwg_option`
--
-- WHERE:  1 LIMIT 0,10000

LOCK TABLES `wpap_bwg_option` WRITE;
/*!40000 ALTER TABLE `wpap_bwg_option` DISABLE KEYS */;
INSERT  IGNORE INTO `wpap_bwg_option` VALUES (1,'wp-content/uploads','vertical','vertical',0,100,5,30,180,90,300,300,1,'none','',5,30,'none',120,90,1,150,1,800,0,0,800,1,5,1,'fade',5,800,500,0,0,1,1,70,0,'top-right',0,'bottom-right',0,'',800,500,'fade',5,1,50,1,1,1,0,0,1,0,0,0,0,1,1,1,0,'none','bottom-left',90,90,'http://tuba-duba.com/wp-content/plugins/photo-gallery/images/watermark.png','web-dorado.com','https://web-dorado.com',20,'Arial','FFFFFF',30,'none','middle-center',15,'http://tuba-duba.com/wp-content/plugins/photo-gallery/images/watermark.png','web-dorado.com',20,'arial.ttf','FFFFFF',30,0,0,0,0,0,0,'thumbnail',0,0,0,180,0,10,'open_lightbox',1,0,0,1,0,0,0,1200,1200,1,0,0,0,0,30,'',0,1,1,1,1,1,0,'',5,300,300,5,'0.75',0,0,800,1,1,1,'manage_options','','',0,0,0,'');
/*!40000 ALTER TABLE `wpap_bwg_option` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-07-22 11:51:28
