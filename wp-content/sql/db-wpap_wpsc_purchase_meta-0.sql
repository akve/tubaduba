...
--
-- Table structure for table `wpap_wpsc_purchase_meta`
--

DROP TABLE IF EXISTS `wpap_wpsc_purchase_meta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wpap_wpsc_purchase_meta` (
...
--
-- Dumping data for table `wpap_wpsc_purchase_meta`
--
-- WHERE:  1 LIMIT 0,10000

LOCK TABLES `wpap_wpsc_purchase_meta` WRITE;
/*!40000 ALTER TABLE `wpap_wpsc_purchase_meta` DISABLE KEYS */;
/*!40000 ALTER TABLE `wpap_wpsc_purchase_meta` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-07-22 11:51:45
