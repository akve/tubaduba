...
--
-- Table structure for table `wpap_wpsc_claimed_stock`
--

DROP TABLE IF EXISTS `wpap_wpsc_claimed_stock`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wpap_wpsc_claimed_stock` (
...
--
-- Dumping data for table `wpap_wpsc_claimed_stock`
--
-- WHERE:  1 LIMIT 0,10000

LOCK TABLES `wpap_wpsc_claimed_stock` WRITE;
/*!40000 ALTER TABLE `wpap_wpsc_claimed_stock` DISABLE KEYS */;
/*!40000 ALTER TABLE `wpap_wpsc_claimed_stock` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-07-22 11:52:02
-- MySQL dump 10.15  Distrib 10.0.25-MariaDB, for Linux (x86_64)
--
-- Host: localhost    Database: ciukrain_wp298
-- ------------------------------------------------------
