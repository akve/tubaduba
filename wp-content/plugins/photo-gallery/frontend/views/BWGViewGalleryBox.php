...
class BWGViewGalleryBox {
  ...
  public function display() {
    ...
    <style>
      ...
      .spider_popup_wrap {
        background-color: #FFFFFF;/*rgba(<?php echo $lightbox_bg_color['red']; ?>, <?php echo $lightbox_bg_color['green']; ?>, <?php echo $lightbox_bg_color['blue']; ?>, <?php echo number_format($lightbox_bg_transparent/ 100, 2, ".", ""); ?>);*/
      ...
      .bwg_ctrl_btn {
        color: #404040;/* #<?php echo $theme_row->lightbox_ctrl_btn_color; ?>;*/
      ...
      .bwg_ctrl_btn_container {
        background-color: rgba(240,240,240,0.3);/*rgba(<?php echo $rgb_lightbox_ctrl_cont_bg_color['red']; ?>, <?php echo $rgb_lightbox_ctrl_cont_bg_color['green']; ?>, <?php echo $rgb_lightbox_ctrl_cont_bg_color['blue']; ?>, <?php echo number_format($theme_row->lightbox_ctrl_cont_transparent / 100, 2, ".", ""); ?>);*/
      ...
      .bwg_toggle_container {
        background: none repeat scroll 0 0 rgba(200,200,200,0.3);/*<?php echo $theme_row->lightbox_ctrl_cont_bg_color; ?>;*/
        <?php
        if ($theme_row->lightbox_ctrl_btn_pos == 'top') {
          ?>
          border-bottom-left-radius: <?php echo $theme_row->lightbox_ctrl_cont_border_radius; ?>px;
      ...
      #spider_popup_right-ico {
        ...
        opacity: 0.6;/*<?php echo number_format($theme_row->lightbox_rl_btn_transparent / 100, 2, ".", ""); ?>;*/
        filter: Alpha(opacity=<?php echo $theme_row->lightbox_rl_btn_transparent; ?>);
      }
      <?php
      $option_row->autohide_lightbox_navigation = false;
