...
class Page_Header extends Abstract_Builder {
	...
	public function page_header_enqueue_scripts() {
		wp_register_script( 'hfg-page-header-customize', NEVE_PRO_INCLUDES_URL . 'modules/header_footer_grid/assets/js/page-header.customize.js', array( 'jquery', 'customize-controls' ), false, true );
		wp_localize_script(
