...
* **Bug Fixes**
   ...
   * [#43](https://github.com/Codeinwp/neve-pro-addon/issues/43) - check if $post exist ([7e0abce](https://github.com/Codeinwp/neve-pro-addon/commit/7e0abce))
   * [#43](https://github.com/Codeinwp/neve-pro-addon/issues/43) - check if $post exist ([0ca58bc](https://github.com/Codeinwp/neve-pro-addon/commit/0ca58bc))
