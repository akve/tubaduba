...
// "
				  ...
				  var data = {
				    oName: $("#billing_first_name").val(),
				    oLastName:$("#billing_last_name").val(),
				    oHeight:$("#billing_height").val(),
				    oEmail:$("#billing_email").val(),
				    oPhone:$("#billing_phone").val(),
				    oCountry:"UA",
				    oCity:$("#billing_city").val(),
				    oSource:$("#billing_source").val(),
				    oComments:$("#order_comments").val(),
				    oAddress:$("#billing_address_1").val()
				  };
						...
						try {
							if ( 'success' === result.result ) {
								  ...
								  var data2 = {
								    ...
								    order: window.CART_PLAIN,
								    time: new Date().toGMTString(),
								    body:htmlEmail
								  };
								  $.post("/sendorder.php", data2, function(response){
