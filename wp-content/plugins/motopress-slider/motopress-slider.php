    ...
    private function getLangStrings(){
        ...
        return array(
	        ...
	        'macros' => array(
		        ...
		        'woo' => array(
			        'add_to_cart' => __('В корзину', 'motopress-slider'),
					'price' => __('Цена', 'motopress-slider'),
					'currency' => __('Валюта', 'motopress-slider'),
					'currency_price' => __('Валюта+цена', 'motopress-slider'),
					'regular_price' => __('Обычная цена', 'motopress-slider'),
					'sale_price' => __('Со скидкой', 'motopress-slider'),
					'in_stock_status' => __('На складе?', 'motopress-slider'),
			        'in_stock_quantity' => __('Кол-во на складе', 'motopress-slider'),
					'weight' => __('Вес', 'motopress-slider'),
					'product_categories' => __('Категории', 'motopress-slider'),
					'product_tags' => __('Теги', 'motopress-slider'),
					'total_sales' => __('Всего продаж', 'motopress-slider'),
					'average_rating' => __('Рейтинг', 'motopress-slider'),
					'rating_count' => __('Оценок', 'motopress-slider')
		        )
	        )
        );
    }
