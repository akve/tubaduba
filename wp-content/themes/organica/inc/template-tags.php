...
if ( ! function_exists( 'organica_cart_link' ) ) {
	function organica_cart_link() {
		...
		<div class="cart-contents">
			<span class="count"><i class="fl-glypho-shopping-cart7"></i><span><?php echo WC()->cart->get_cart_contents_count();?></span></span>
		</div>
		<?php
	}
}
