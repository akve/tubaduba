 ...
 * @return void
 */
function organica_meta_author( $context = 'loop', $args = array() ) {
	...
	if ( ! organica_is_meta_visible( $meta, $context ) ) {
		return;
	}
 ...
 * @return void
 */
function organica_meta_date( $context = 'loop', $args = array() ) {
 ...
 * @return void
 */
function organica_meta_comments( $context = 'loop', $args = array() ) {
 ...
 * @return void
 */
function organica_meta_categories( $context = 'loop', $args = array(), $echo = true ) {
	...
	$categories_format = apply_filters(
		'organica_meta_categories_format',
 ...
 * @return void
 */
function organica_meta_tags( $context = 'loop', $args = array() ) {
 ...
 * @return array
 */
function organica_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	$default_config = apply_filters( 'organica_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'organica_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'organica' ) . $network['name'],
 ...
 * @return bool
 */
function organica_is_meta_visible( $meta, $context = 'loop' ) {

	if ( ! $meta ) {
		return false;
	}

	$meta_enabled = get_theme_mod( $meta, organica_theme()->customizer->get_default( $meta ) );
