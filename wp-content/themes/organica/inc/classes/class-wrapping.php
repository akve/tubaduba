 ...
 */
add_filter( 'template_include', array( 'Organica_Wrapping', 'wrap' ), 99 );
add_filter( 'organica_wrap_base', 'organica_wrap_base_cpts' );
 ...
 */
function organica_template_path() {
	return Organica_Wrapping::$main_template;
}
 ...
 */
function organica_template_base() {
	return Organica_Wrapping::$base;
}

if ( ! class_exists( 'Organica_Wrapping' ) ) {
	...
	class Organica_Wrapping {
		...
		/**
		 * Initialize new instance of Organica_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'organica_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Organica_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function organica_wrap_base_cpts( $templates ) {
