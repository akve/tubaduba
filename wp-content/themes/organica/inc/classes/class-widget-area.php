...
if ( ! class_exists( 'Organica_Widget_Area' ) ) {

	class Organica_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'organica_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'organica_rendering_current_widget_area', $area_id );
	...
	function organica_widget_area() {
		return Organica_Widget_Area::get_instance();
	}

	organica_widget_area();
}
