...
<table class="shop_table customer_details">
	...
	<?php if ( $order->get_billing_email() ) : ?>
		<tr>
			<th><?php esc_html_e( 'Email:', 'organica' ); ?></th>
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() ) : ?>
	...
	<div class="col-2">
		<header class="title">
			<h3><?php esc_html_e( 'Shipping Address', 'organica' ); ?></h3>
		</header>
		<address>
			<?php echo ( $address = $order->get_formatted_shipping_address() ) ? $address : esc_html__( 'N/A', 'organica' ); ?>
		</address>
	</div><!-- /.col-2 -->
</div><!-- /.col2-set -->
