...
if ( has_post_thumbnail() ) {
	...
	wp_enqueue_script( 'jssor-init', ORGANICA_THEME_URI . '/assets/js/single_product.js', array( 'jquery-jssor' ), '1.0.0', true );
	...
	<div class="single-product-images single-product-images-<?php echo $vertical ? 'vertical' : 'horizontal'; ?>"
		...
		<div data-u="thumbnavigator" class="jssort01-99-66"
		     style="left: 0; bottom: 0;<?php echo $vertical ? 'width: ' . $thumb_size['width'] . 'px; height: ' . $image_size['height'] . 'px;' : 'width: ' . $image_size['width'] . 'px; height: ' . $thumb_size['height'] . 'px;'; ?>">
			<!-- Thumbnail Item Skin Begin -->
			<div data-u="slides">
				<div data-u="prototype" class="p"
				     style="<?php echo 'height: ' . $thumb_size['height'] . 'px; width: ' . $thumb_size['width'] . 'px'; ?>">
					<div class="w">
	...
	echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__( 'Placeholder', 'organica' ) ), $post->ID );
}
?>